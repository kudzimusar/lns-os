...
const parentSidebarItems = [
  ...
  { name: "Grades & Progress", icon: GraduationCap, href: "/parent/grades" },
  { name: "Attendance", icon: Users, href: "/parent/attendance" },
  { name: "Messages", icon: MessageSquare, href: "/parent/messaging" },
];
    ...
    <div className="flex min-h-screen bg-lns-light-grey">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-lns-border h-20 px-6 flex items-center justify-between z-50">
        ...
        <Link 
          ...
          className={cn(
            "flex flex-col items-center space-y-1 transition-all",
            pathname === "/parent/profile" ? "text-lns-red" : "text-lns-mid-grey"
          )}
        >
          <User size={24} />
